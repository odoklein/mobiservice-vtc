...
const FORFAITS_MDA = [
  { hours: '2H', km: 180, dayHT: 210.91, dayTTC: 232, nightHT: 255.55, nightTTC: 280, hourlyDay: 116, hourlyNight: 140 },
  { hours: '2H30', km: 225, dayHT: 263.64, dayTTC: 290, nightHT: 306.82, nightTTC: 337.50, hourlyDay: 116, hourlyNight: 135 },
  { hours: '3H', km: 270, dayHT: 316.37, dayTTC: 348, nightHT: 354.55, nightTTC: 390, hourlyDay: 116, hourlyNight: 130 },
  { hours: '3H30', km: 315, dayHT: 369.10, dayTTC: 406, nightHT: 413.64, nightTTC: 455, hourlyDay: 116, hourlyNight: 130 },
  { hours: '4H', km: 360, dayHT: 421.82, dayTTC: 464, nightHT: 472.28, nightTTC: 520, hourlyDay: 116, hourlyNight: 130 },
  { hours: '4H30', km: 405, dayHT: 474.55, dayTTC: 522, nightHT: 531.82, nightTTC: 585, hourlyDay: 116, hourlyNight: 130 },
  { hours: '5H', km: 450, dayHT: 527.28, dayTTC: 580, nightHT: 590.91, nightTTC: 650, hourlyDay: 116, hourlyNight: 130 },
  { hours: '5H30', km: 495, dayHT: 580, dayTTC: 638, nightHT: 650, nightTTC: 715, hourlyDay: 116, hourlyNight: 130 },
  { hours: '6H', km: 540, dayHT: 600, dayTTC: 660, nightHT: 681.82, nightTTC: 750, hourlyDay: 110, hourlyNight: 125 },
  { hours: '6H30', km: 585, dayHT: 650, dayTTC: 715, nightHT: 738.64, nightTTC: 812.50, hourlyDay: 110, hourlyNight: 125 },
  { hours: '7H', km: 630, dayHT: 668.19, dayTTC: 735, nightHT: 763.64, nightTTC: 840, hourlyDay: 105, hourlyNight: 120 },
  { hours: '7H30', km: 675, dayHT: 715.91, dayTTC: 787.50, nightHT: 818.19, nightTTC: 900, hourlyDay: 105, hourlyNight: 120 },
      ...
      <section className="bg-[#0A0A0A] py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Des tarifs
            <span className="text-[#5CD85A]"> transparents</span>
          </h1>
          <p className="text-xl text-white/70 max-w-2xl mx-auto mb-8">
            Tous nos prix sont affichés clairement, sans surprise
          </p>
          <a 
      ...
      <section className="py-6 bg-white border-b">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center gap-3 text-gray-700">
            ...
            <span className="font-medium">Point de départ et retour :</span>
            <span className="text-[#0A0A0A] font-semibold">{VTC_DEPOT.address}</span>
          </div>
        </div>
      </section>
              ...
              <div className="bg-white rounded-2xl p-6 border border-indigo-200">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">20h00 - 7h00 + dim/JF</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              <h2 className="text-3xl font-bold text-[#0A0A0A] mb-3">Point à Point - Forfait Agglomération</h2>
              <p className="text-gray-600">Jusqu'à 25 km aller-retour inclus</p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-10">
              <h2 className="text-3xl font-bold text-[#0A0A0A] mb-3">Point à Point - Hors Agglomération</h2>
              <p className="text-gray-600">Au-delà de 25 km aller-retour (A/S ou A/R)</p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-10">
              ...
              <h2 className="text-3xl font-bold text-[#0A0A0A] mb-3">Mise à Disposition (MDA)</h2>
                ...
                <tbody>
                  {FORFAITS_MDA.map((f, i) => (
                    <tr key={f.hours} className={`border-b hover:bg-gray-50 ${i % 2 === 0 ? 'bg-white' : 'bg-gray-50/50'}`}>
                      <td className="p-4 font-bold text-[#0A0A0A]">{f.hours} ou {f.km} km</td>
                      <td className="p-4 text-center text-gray-600">{f.km} km</td>
                      <td className="p-4 text-center">
                        <span className="font-bold text-amber-700 text-lg">{f.dayTTC}€</span>
                        <span className="text-gray-400 text-xs block">({f.dayHT.toFixed(2)}€ HT)</span>
                      </td>
                      <td className="p-4 text-center">
                        <span className="font-bold text-indigo-700 text-lg">{f.nightTTC}€</span>
                        <span className="text-gray-400 text-xs block">({f.nightHT.toFixed(2)}€ HT)</span>
                      </td>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-[#0A0A0A] mb-2">Mise à Disposition - Attente</h3>
              <p className="text-gray-600">10 minutes gratuites, au-delà tarif à la minute</p>
            </div>
              ...
              <CardContent className="p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-gray-700">Tous les prix sont <strong>TTC</strong> (TVA 10%)</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-[#5CD85A] flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700">Péages <strong>inclus</strong> dans les forfaits MDA</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-[#5CD85A] flex-shrink-0 mt-0.5" />
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-[#5CD85A] flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700">MDA = Mise à disposition en sus (Point à Point)</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-[#5CD85A] flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700">Départ et retour au <strong>dépôt VTC</strong></span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-[#5CD85A] flex-shrink-0 mt-0.5" />
