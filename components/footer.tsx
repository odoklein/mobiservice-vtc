          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                <div className="flex items-center gap-2 text-white/50 text-xs">
                  <Shield className="h-4 w-4 text-[#5CD85A]" />
                  <span>Sécurisé</span>
                </div>
                <div className="flex items-center gap-2 text-white/50 text-xs">
                  <Clock className="h-4 w-4 text-[#5CD85A]" />
                  <span>24/7</span>
                </div>
                <div className="flex items-center gap-2 text-white/50 text-xs">
            ...
            <div>
              <h3 className="font-semibold mb-6 text-white flex items-center gap-2">
                <span className="w-8 h-0.5 bg-gradient-to-r from-[#5CD85A] to-transparent rounded-full"></span>
                Navigation
              </h3>
              <ul className="space-y-3">
                {NAV_ITEMS.map((item) => (
                  <li key={item.href}>
                    <Link
                      href={item.href}
                      className="text-sm text-white/60 hover:text-[#5CD85A] transition-colors duration-300 flex items-center gap-2 group"
                    >
            ...
            <div>
              <h3 className="font-semibold mb-6 text-white flex items-center gap-2">
                <span className="w-8 h-0.5 bg-gradient-to-r from-[#B8D4E3] to-transparent rounded-full"></span>
                Services
              </h3>
              <ul className="space-y-3">
                <li>
              ...
              <ul className="space-y-4">
                <li>
                  <a
                    ...
                    className="flex items-center gap-3 text-white/60 hover:text-[#5CD85A] transition-colors duration-300 group"
                  >
                    <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center group-hover:border-[#5CD85A]/30 group-hover:bg-[#5CD85A]/5 transition-all duration-300">
